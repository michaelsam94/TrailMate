...
import com.example.core.Result as AppResult
...
class ActiveRunViewModelTest {
    ...
    private val locationFlow = MutableSharedFlow<AppResult<Waypoint, com.example.domain.error.DomainError>>(extraBufferCapacity = 10)
